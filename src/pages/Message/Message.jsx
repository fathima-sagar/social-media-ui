...
const Message = () => {
  ...
  const onConnect = () => {
    console.log("websocket connetced");
  };
  ...
  const onMessageReceive = (payload) => {
    ...
    console.log("message receive from websocket", recievedMessage);
  };
          ...
          {currentChat ? (
            <div>
              ...
              <div className="sticky bottom-0 border-l">
                ...
                <div className="py-5 flex items-center space-x-5 justify-center">
                  <input
                    onKeyPress={(e) => {
